...
public abstract class DataBaseIncremental<T> implements Serializable{
     ...
     */
    protected abstract T construirElemento(int id, Object...args);
     ...
     */
    protected T addElemento(Object...args) {
        T nuevoElemento = construirElemento(indiceInc, args);
